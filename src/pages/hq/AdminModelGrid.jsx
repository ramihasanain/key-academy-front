...
const SCHEMAS = {
    ...
    courses: { title: 'الدورات المجانية والمدفوعة', endpoint: 'courses', columns: [{ key: 'title', label: 'اسم الدورة' }, { key: 'price', label: 'السعر', type: 'currency' }, { key: 'branches_str', label: 'الفروع (M)' }, { key: 'enrollments_count', label: 'عدد الطلاب', type: 'number_badge' }, { key: 'is_published', label: 'فعالة', type: 'boolean' }], filters: [{ key: 'teacher', label: 'الأستاذ', optionsKey: 'teachers' }, { key: 'subject__icontains', label: 'المادة', optionsKey: 'subjects' }, { key: 'grade__icontains', label: 'المرحلة', optionsKey: 'grades' }, { key: 'branches__name__icontains', label: 'الفرع', optionsKey: 'branches' }, { key: 'is_published', label: 'حالة النشر', options: [{ value: 'true', label: 'منشور' }, { value: 'false', label: 'مسودة' }] }] },
    teachers: { title: 'الأساتذة', endpoint: 'teachers', columns: [{ key: 'name', label: 'الاسم ' }, { key: 'subject', label: 'المادة' }, { key: 'grade', label: 'الصف' }, { key: 'branches_str', label: 'الفروع (M)' }, { key: 'enrollments_count', label: 'الطلاب المسجلين', type: 'number_badge' }, { key: 'is_active', label: 'مفعل', type: 'boolean' }], filters: [{ key: 'subject__icontains', label: 'المادة', optionsKey: 'subjects' }, { key: 'grade__icontains', label: 'المرحلة', optionsKey: 'grades' }, { key: 'branches__name__icontains', label: 'الفرع', optionsKey: 'branches' }, { key: 'is_active', label: 'حالة الحساب', options: [{ value: 'true', label: 'مفعل' }, { value: 'false', label: 'معطل' }] }] },
    teacherassistants: {
