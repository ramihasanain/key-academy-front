...
const SCHEMAS = {
    ...
    teacherassistants: {
        ...
        columns: [ { key: 'name', label: 'اسم المساعد' }, { key: 'teacher_str', label: 'التابع للأستاذ' }, { key: 'groups_str', label: 'مجموعاته المنفصلة' }, { key: 'phone', label: 'رقم الهاتف' }, { key: 'total_replies', label: 'إجابات الأسئلة', type: 'number_badge' }, { key: 'total_messages', label: 'رسائل التوجيه', type: 'number_badge' }, { key: 'is_active', label: 'مفعل', type: 'boolean' } ],
