...
const CourseChatDrawer = ({ courseId, userData, onClose, readOnly = false }) => {
    return (
        ...
        >
            ...
            >
                <div style={{ padding: '20px', background: 'linear-gradient(135deg, var(--purple), var(--pink))', color: 'white', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexShrink: 0 }}>
                    <div>
                                                                        ...
                                                                        <div key={`doc-l-${lesson.id}`} className="cv-file-row">
                                                                            <div className="cv-file-info">
                                                                                ...
                                                                                <div className="cv-file-texts">
                                                                                    <h4>{lesson.doc_title || lesson.doc_name}</h4>
                                                                                    <span>ملف PDF • الحجم: {lesson.doc_size || '1.5MB'}</span>
                                                                                </div>
                                                                            </div>
                                                                            <button className="cv-btn-download-circle" title="عرض الملف" onClick={(e) => handleViewDoc(e, lesson.doc_file, lesson.doc_title || lesson.doc_name)}>
                                                                                <HiOutlineDocumentText />
                                                                            </button>
                                                                        </div>
                                                                    ))
