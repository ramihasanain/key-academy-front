      ...
      <nav className={`navbar ${scrolled ? "scrolled" : ""}`}>
        <div className="container">
          ...
          <div className={`nav-links ${menuOpen ? "open" : ""}`}>
            ...
            >
              ...
              <div className="dropdown-menu">
                ...
                <Link to="/grades/sixth-scientific" className="dropdown-item">
                  <div className="dropdown-item-icon science">
                    <HiOutlineAcademicCap />
                  </div>
                  الفرع العلمي
                </Link>
                <Link to="/grades/sixth-literary" className="dropdown-item">
                  <div className="dropdown-item-icon literary">
                    <HiOutlineBookOpen />
                  </div>
                  الفرع الأدبي
                </Link>
            ...
            <Link to="/faq" className={`nav-link ${isActive("/faq")}`}>
              الأسئلة الشائعة
            </Link>
            ...
            <div className="nav-cta">
              ...
              <Link to="/signup" className="nav-start-btn">
                يلا نبدي
              </Link>
            </div>
          </div>
          ...
          <div className="nav-left-section">
            <img
              src="/key-icon-logo.png"
              alt="Key Academy Icon"
